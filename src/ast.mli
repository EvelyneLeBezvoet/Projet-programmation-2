...
and pexpr_desc =
  ...
  | PEassign of pexpr list * pexpr list (*assigne une valeur*)
...
type pfield = ident * ptyp  (*comme pparam mais pour les structures*)
...
type pdecl = (*morceaux principaux du code*)
  | PDfunction of pfunc
  | PDstruct   of pstruct
